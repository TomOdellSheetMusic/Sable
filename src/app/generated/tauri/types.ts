 ...
 * Generated at: 2026-09-10T16:36:44.147977404+00:00
 * Generator: none
 *
...
export interface PrepareLoopbackMediaParams {
  url: string;
  [key: string]: unknown;
}
...
export interface SaveMediaDownloadParams {
  url: string;
  filename: string;
  [key: string]: unknown;
}
...
export interface SetToggleWindowShortcutParams {
  binding?: string | null;
  [key: string]: unknown;
}
...
export interface SetWindowBackgroundColorParams {
  color: number;
  [key: string]: unknown;
}
